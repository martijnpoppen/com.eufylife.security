...
exports.init = async function (homey) {
    try {
        ...
        homey.app.condition_KNOWN_FACE = homey.flow.getConditionCard('condition_KNOWN_FACE').registerRunListener(async (args, state) => {
            const value = args.condition_KNOWN_FACE;

            homey.app.log('condition_KNOWN_FACE', { args: value, deviceValue: args.device.getCapabilityValue('NTFY_KNOWN_FACE_DETECTION') });
