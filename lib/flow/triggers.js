...
exports.init = async function (settings) {
    ...
    try {
        ...
        Homey.app.trigger_NTFY_CRYING_DETECTED = new Homey.FlowCardTrigger('trigger_NTFY_CRYING_DETECTED')
        .registerRunListener(onTriggerNtfy)
        .register()
        .getArgument('devicelist')
        .registerAutocompleteListener(utils.onDeviceListVariableAutocomplete);

        Homey.app.trigger_NTFY_SOUND_DETECTED = new Homey.FlowCardTrigger('trigger_NTFY_SOUND_DETECTED')
        .registerRunListener(onTriggerNtfy)
        .register()
        .getArgument('devicelist')
        .registerAutocompleteListener(utils.onDeviceListVariableAutocomplete);

        Homey.app.trigger_NTFY_PET_DETECTED = new Homey.FlowCardTrigger('trigger_NTFY_PET_DETECTED')
        .registerRunListener(onTriggerNtfy)
        .register()
        .getArgument('devicelist')
        .registerAutocompleteListener(utils.onDeviceListVariableAutocomplete);
