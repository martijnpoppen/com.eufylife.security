...
exports.init = async function (homey) {
    try {
        ...
        homey.app.action_CMD_SET_ARMING.registerRunListener(async (args, state) => {
            ...
            return await args.device.setCapabilityValue('CMD_SET_ARMING', args.action_CMD_SET_ARM_TYPE).catch(homey.app.error);;
        });
        ...
        homey.app.action_CMD_DOORBELL_QUICK_RESPONSE.registerRunListener(async (args, state) => {
            ...
            return await args.device.setCapabilityValue('CMD_DOORBELL_QUICK_RESPONSE', args.action_CMD_SET_QUICK_RESPONSE_TYPE).catch(homey.app.error);;
        });
        ...
        homey.app.action_CMD_SNAPSHOT.registerRunListener(async (args, state) => {
            return await args.device.onCapability_CMD_SNAPSHOT('snapshot');
        });
        ...
        homey.app.action_CMD_SNAPSHOT_CUSTOM.registerRunListener(async (args, state) => {
            return await args.device.onCapability_CMD_SNAPSHOT('snapshot', args.url);
        });
        ...
        homey.app.action_CMD_RECORD.registerRunListener(async (args, state) => {
            return await args.device.onCapability_CMD_SNAPSHOT('gif');
        });
