...
exports.init = async function () {
    try {
      ...
      Homey.app.action_CMD_SET_HUB_ALARM_COUNTDOWN = new Homey.FlowCardAction('action_CMD_SET_HUB_ALARM_COUNTDOWN')
      .registerRunListener( async ( args, state ) => {
        return await args.device.onCapability_CMD_SET_HUB_ALARM_COUNTDOWN(true);
      })
      .register(); 
