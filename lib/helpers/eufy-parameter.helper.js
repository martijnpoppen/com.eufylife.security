...
const { CommandType } = require('../eufy-homey-client');
...
exports.unregisterTask = async function(id) {
    try {
        Homey.app.log('unregisterTask', id);
        ManagerCron.unregisterTask(id);
    } catch (error) {
        Homey.app.log(error);
    }   
}
