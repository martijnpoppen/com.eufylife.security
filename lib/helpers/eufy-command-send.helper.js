...
exports.sendCommand = function(commandTypeString, station_sn, commandType, value, channel = null) {
        ...
        if(_devClientService[station_sn] && _devClientService[station_sn].isConnected()) {
            ...
            setTimeout(() => {
                if(channel === null) {
                    ...
                    Homey.app.log(`${station_sn} - Sending Command with IntString - ${commandTypeString}/${commandType} | channel: ${channel} | value: ${value}`);
                    _devClientService[station_sn].sendCommandWithIntString(commandType, value, channel);
                }
                resolve(true);
            }, timer);
        } else {
