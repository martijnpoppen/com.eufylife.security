...
class EufyP2P {
    ...
    async initP2P(hub, station_sn, retryCount = 2) {
        try {
            ...
            Homey.app.error(`[P2P] - ${station_sn} - Connecting failed - retrying `, retryCount - 1);
            return await this.initP2P(hub, station_sn, retryCount - 1)
        }
    }
