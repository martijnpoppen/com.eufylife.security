    ...
    async enforceSettings() {
        try {
            this.homey.app.deviceList.every(async (homeyDevice) => {
                ...
                if (this.homey.app.eufyClient && settings.force_switch_mode_notifications && settings.STATION_SN) {
                ...
                if (this.homey.app.eufyClient && settings.force_include_thumbnail && homeyDevice.EufyDevice && homeyDevice.EufyDevice.hasProperty(PropertyName.DeviceNotificationType) && settings.DEVICE_SN) {
