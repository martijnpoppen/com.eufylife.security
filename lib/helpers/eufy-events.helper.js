...
module.exports = class eufyEventsHelper {
    ...
    async enforceSettings() {
        this.homey.app.deviceList.forEach(async (d) => {
            try {
                ...
                if (d._started && this.homey.app.eufyClient) {
                    if (settings.force_switch_mode_notifications && d.EufyStation) {
                        ...
                        if (await this.homey.app.eufyClient.getStation(settings.STATION_SN)) {
                        ...
                        if (await this.homey.app.eufyClient.getDevice(settings.DEVICE_SN)) {
