...
async function eufyPushClient() {
    ...
    _pushClient.connect((msg) => {
        ...
        if(+new Date - _msg.sent < 11000) {
            ...
            if(event_type && message && (pic_url && push_count !== 2 || pic_url && notification_style === 3 && push_count === 2 || push_count !== 2) && device_sn) {
...
function getData(msg) {
    ...
    const notification_style = utils.get(msg, 'payload.payload.push_count', 2)
