...
module.exports = class eufyNotificationCheckHelper {
    constructor(homey) {
        ...
        this.init();
        const deviceSN = 'T821451023371C74'
        const HomeyDevice = this.homey.app.deviceList.find(d => d.HomeyDevice.device_sn === deviceSN);
        this.triggerFlow(HomeyDevice, deviceSN, 'NTFY_KNOWN_FACE_DETECTION', 'Martijn', 'Martijn');
    }
