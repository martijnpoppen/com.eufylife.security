...
async function eufyPushClient() {
    ...
    _pushClient.connect((msg) => {
        ...
        if(+new Date - _msg.sent < 11000) {
            ...
            if(event_type && message && device_sn && (pic_url && push_count !== 2 && notification_style !== 3 || pic_url && push_count === 2 && notification_style === 3 || push_count !== 2 && notification_style !== 3 || DEVICE_TYPES.FLOODLIGHT_CAMERA.some(d => device_sn.startsWith(d)))) {
