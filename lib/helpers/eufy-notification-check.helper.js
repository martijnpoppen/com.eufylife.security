...
module.exports = class eufyNotificationCheckHelper {
    ...
    async init() {
        try {
            ...
            this.homey.app.eufyClient.on('device person detected', (device, state, person) => this.handleDeviceNotification(device, {...state, person}, 'NTFY_FACE_DETECTION'));
